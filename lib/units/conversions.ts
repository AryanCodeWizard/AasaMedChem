...
// Convert quantity to its base unit
export function toBaseUnit(
  qty: number,
  fromUnit: UnitCode,
  units: UnitRow[] = UNIT_DEFINITIONS
): number {
...
// Convert base quantity to target unit
...
// Format base quantity for display
